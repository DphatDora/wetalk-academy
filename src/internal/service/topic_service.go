...
func (s *TopicService) CreateTopic(ctx context.Context, userId uint64, req *request.CreateTopicRequest) error {
	...
	if err := s.topicRepo.CreateTopic(ctx, topic); err != nil {
		logger.ErrorfWithCtx(ctx, "[Err] Error creating topic in TopicService.CreateTopic: %v", err)
...
func (s *TopicService) GetTopics(ctx context.Context, page, limit int) ([]*response.TopicResponse, int64, error) {
	...
	if err != nil {
		logger.ErrorfWithCtx(ctx, "[Err] Error getting topics in TopicService.GetTopics: %v", err)
...
func (s *TopicService) GetTopicBySlug(ctx context.Context, slug string) (*response.TopicResponse, error) {
	...
	if err != nil {
		...
		logger.ErrorfWithCtx(ctx, "[Err] Error getting topic in TopicService.GetTopicBySlug: %v", err)
...
func (s *TopicService) UpdateTopic(ctx context.Context, slug string, userId uint64, req *request.UpdateTopicRequest) error {
	...
	if err != nil {
		...
		logger.ErrorfWithCtx(ctx, "[Err] Error getting topic in TopicService.UpdateTopic: %v", err)
	...
	if err := s.topicRepo.UpdateTopic(ctx, existingTopic); err != nil {
		logger.ErrorfWithCtx(ctx, "[Err] Error updating topic in TopicService.UpdateTopic: %v", err)
...
func (s *TopicService) DeleteTopic(ctx context.Context, slug string, userId uint64) error {
	...
	if err != nil {
		...
		logger.ErrorfWithCtx(ctx, "[Err] Error getting topic in TopicService.DeleteTopic: %v", err)
		return fmt.Errorf("failed to get topic: %w", err)
	}
	...
	if err != nil {
		logger.ErrorfWithCtx(ctx, "[Err] Error counting lessons in TopicService.DeleteTopic: %v", err)
	...
	if err := s.topicRepo.DeleteTopic(ctx, slug); err != nil {
		logger.ErrorfWithCtx(ctx, "[Err] Error deleting topic in TopicService.DeleteTopic: %v", err)
...
func (s *TopicService) GetLessonsInTopic(ctx context.Context, slug string, page, limit int) ([]*response.LessonResponse, int64, error) {
	...
	if err != nil {
		...
		logger.ErrorfWithCtx(ctx, "[Err] Error getting topic in TopicService.GetLessonsInTopic: %v", err)
	...
	if err != nil {
		logger.ErrorfWithCtx(ctx, "[Err] Error getting lessons in TopicService.GetLessonsInTopic: %v", err)

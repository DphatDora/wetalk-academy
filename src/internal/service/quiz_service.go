...
func (s *QuizService) CreateQuiz(ctx context.Context, userID uint64, req *request.CreateQuizRequest) error {
	...
	if err != nil {
		...
		logger.ErrorfWithCtx(ctx, "[Err] Error getting lesson in QuizService.CreateQuiz: %v", err)
	...
	if err := s.quizRepo.CreateQuiz(ctx, quiz); err != nil {
		logger.ErrorfWithCtx(ctx, "[Err] Error creating quiz in QuizService.CreateQuiz: %v", err)
...
func (s *QuizService) GetQuizByID(ctx context.Context, quizID string) (*response.QuizResponse, error) {
	...
	if err != nil {
		...
		logger.ErrorfWithCtx(ctx, "[Err] Error getting quiz in QuizService.GetQuizByID: %v", err)
...
func (s *QuizService) GetQuizzesByLessonSlug(ctx context.Context, lessonSlug string) ([]*response.QuizSummaryResponse, error) {
	...
	if err != nil {
		...
		logger.ErrorfWithCtx(ctx, "[Err] Error getting lesson in QuizService.GetQuizzesByLessonSlug: %v", err)
		return nil, fmt.Errorf("failed to get lesson: %w", err)
	}

	quizzes, err := s.quizRepo.GetQuizzesByLessonID(ctx, lesson.ID.Hex())
	if err != nil {
		logger.ErrorfWithCtx(ctx, "[Err] Error getting quizzes in QuizService.GetQuizzesByLessonSlug: %v", err)
...
func (s *QuizService) UpdateQuiz(ctx context.Context, quizID string, userID uint64, req *request.UpdateQuizRequest) error {
	...
	if err != nil {
		...
		logger.ErrorfWithCtx(ctx, "[Err] Error getting quiz in QuizService.UpdateQuiz: %v", err)
	...
	if err != nil {
		...
		logger.ErrorfWithCtx(ctx, "[Err] Error getting lesson in QuizService.UpdateQuiz: %v", err)
		return fmt.Errorf("failed to get lesson: %w", err)
	}
	...
	if err := s.quizRepo.UpdateQuiz(ctx, quiz); err != nil {
		logger.ErrorfWithCtx(ctx, "[Err] Error updating quiz in QuizService.UpdateQuiz: %v", err)
...
func (s *QuizService) DeleteQuiz(ctx context.Context, quizID string, userID uint64) error {
	...
	if err != nil {
		...
		logger.ErrorfWithCtx(ctx, "[Err] Error getting quiz in QuizService.DeleteQuiz: %v", err)
		return fmt.Errorf("failed to get quiz: %w", err)
	}
	...
	if err != nil {
		...
		logger.ErrorfWithCtx(ctx, "[Err] Error getting lesson in QuizService.DeleteQuiz: %v", err)
		return fmt.Errorf("failed to get lesson: %w", err)
	}
	...
	if err := s.quizRepo.DeleteQuiz(ctx, quizID); err != nil {
		logger.ErrorfWithCtx(ctx, "[Err] Error deleting quiz in QuizService.DeleteQuiz: %v", err)
...
func (s *QuizService) checkTopicOwnership(ctx context.Context, topicID string, userID uint64) error {
	...
	if err != nil {
		...
		logger.ErrorfWithCtx(ctx, "[Err] Error getting topic in QuizService.checkTopicOwnership: %v", err)
